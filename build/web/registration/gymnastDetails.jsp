<%-- 
    ...
    Created on : 3 May 2024, 10:22:52 pm
    Author     : 60199
--%>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="addGymnastForm">
          <div class="mb-3">
            <label for="gymnastName" class="form-label">Gymnast Name</label>
            <input type="text" class="form-control" id="gymnastName" required>
          </div>
            <div class="mb-3">
            ...
            <input type="file" class="form-control" id="icPic" required>
          </div>
            <div class="mb-3">
            <label for="schools" class="form-label">School</label>
            <input type="text" class="form-control" id="schools" required>
          </div>
            <div class="mb-3">
        ...
        <div class="col-md-6">
            ...
            <div class="d-flex">
                <select id="categoryFilter" class="form-select me-2"> 
                    ...
                    <option value="Pre-Junior Under 12">Pre-Junior Under 12</option>
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="color: blue !important; font-size: 0.9rem !important;">Name</th>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="color: blue !important; font-size: 0.9rem !important;">School</th>
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="color: blue !important; font-size: 0.9rem !important;">Category</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">Ter Bowie</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="align-middle text-center category-cell">
                                            <span class="text-secondary text-xs font-weight-bold">Pre-Junior Under 12</span>
                                        </td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Updates Gymnast Information</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <form id="myForm">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Identity Card</label>
                        <input type="password" class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputImage" class="form-label">Identity Card Image</label>
                        <input type="file" class="form-control" id="exampleInputImage">
                          <div id="name" class="form-text">We'll never share your image with anyone else.</div>
                    </div>
                     <div class="mb-3">
                        <label for="exampleInputSchool" class="form-label">School</label>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">Ling Guan Eng</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">Nurul Amalina</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="align-middle text-center category-cell">
                                            <span class="text-secondary text-xs font-weight-bold">Pre-Junior Under 17</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="bi bi-file-earmark-check-fill bi-lg"></i> <!-- Large size -->
