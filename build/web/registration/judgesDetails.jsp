<%-- 
    Document   : judgesDetails
    Created on : 3 May 2024, 9:42:42 pm
    Author     : 60199
--%>
...
<head>
    ...
    <title>Judge Personal Information</title>
</head>
<body>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <div class="d-flex">
                ...
                <a href="#" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addJudgeModal">Add</a>
            </div>
        </div>            
    </div>
</div>
    ...
    <div class="modal fade" id="addJudgeModal" tabindex="-1" aria-labelledby="addJudgeModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Updates Judges Information</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <form id="myForm">
                    ...
                    <div class="mb-3">
                            <label for="exampleInputDuty" class="form-label">Place Of Duty</label>
...
<!-- Add your custom JavaScript to handle form submission if needed -->
<script>
